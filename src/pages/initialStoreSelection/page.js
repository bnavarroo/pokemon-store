  ...
  return (
    <WelcomeTemplate>
      ...
      <div className="d-flex justify-content-center flex-column-reverse justify-content-lg-between flex-lg-row mt-4">
        <Link to={Sitemap.InitialUserIdentificationPage.path} className="btn btn-lg btn-link px-0 mt-3 mt-lg-0">Ir para identificação</Link>
        <Link to={Sitemap.CatalogPage.path} className="btn btn-lg __btn-store-primary">Acessar <b>{store.name}</b></Link>
      </div>
    </WelcomeTemplate>
  );
};
